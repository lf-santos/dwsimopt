NET.addAssembly('C:\Users\lfsfr\AppData\Local\DWSIM6\DWSIM.Automation.dll');
NET.addAssembly('C:\Users\lfsfr\AppData\Local\DWSIM6\DWSIM.Interfaces.dll');
NET.addAssembly('C:\Users\lfsfr\AppData\Local\DWSIM6\CapeOpen.dll');

%create automation manager
interf = DWSIM.Automation.Automation();
sim = interf.LoadFlowsheet("CavettProblem.dwxml");
